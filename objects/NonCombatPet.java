...
public class NonCombatPet extends Pet implements Serializable, MessageDispatch
{
    ...
    public void summonPet() {
        ...
        // log.error("Pet Combat: "+tmpl+" "+ tmpl.get(WorldManagerClient.NAMESPACE, "displays"));
     	String meshName = "";
    	...
    	try {
    		...
    		log.error("SummonPet: owner no movement speed");
    	}
    	...
    	log.debug("NonCobatPet summonPet: spawnData:"+spawnData);
    	ObjectStub obj = null;
        ...
        isSpawned = true;
        mobObj = obj.getOid();
        Log.debug("NonCobatPet summonPet: Pet OID "+mobObj);
      ...
      //    EnginePlugin.setObjectProperty(ownerOid, WorldManagerClient.NAMESPACE, "hasPet", true);
        ...
        updatePetStats();
    //    applyPassiveEffect();
		log.debug("NonCobatPet summonPet Done " + this.despawnTime);
		if (this.despawnTime > 0) {
			log.debug("NonCobatPet summonPet Done");
		...
		// scheduledExecutioner = Engine.getExecutor().schedule(sp, 1 ,
		// TimeUnit.SECONDS);
	}
