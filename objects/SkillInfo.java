...
public class SkillInfo implements Serializable {
	...
	public SkillData addSkill(SkillTemplate tmpl) {
		...
		SkillData skillData = new SkillData(tmpl.getSkillID(), tmpl.getSkillName(), 0, 1, tmpl.getMaxLevel()/* ClassAbilityPlugin.SKILL_STARTING_MAX */, tmpl.getParentSkill(), tmpl.isTalent());
