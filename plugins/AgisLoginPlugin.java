		...
		for (OID oid : charIds) {
			...
			if (cooldownList.size() > 0) {
				...
				if(CombatPlugin.ABILITY_COOLDOWN_MOD_STAT!=null) {
					int statValue = entity2.statGetCurrentValue(CombatPlugin.ABILITY_COOLDOWN_MOD_STAT);
					if (Log.loggingDebug)
				...
				if(CombatPlugin.ABILITY_GLOBAL_COOLDOWN_MOD_STAT!=null) {
					int statValue = entity2.statGetCurrentValue(CombatPlugin.ABILITY_GLOBAL_COOLDOWN_MOD_STAT);
					if (Log.loggingDebug)
				...
				if(CombatPlugin.ABILITY_WEAPON_COOLDOWN_MOD_STAT!=null) {
					int statValue = entity2.statGetCurrentValue(CombatPlugin.ABILITY_WEAPON_COOLDOWN_MOD_STAT);
					if (Log.loggingDebug)
